 ...
 */
public class CategoryJsonRepositoryImpl extends GenericJsonRepository<Category> implements
    CategoryRepository {
  ...
  public CategoryJsonRepositoryImpl(Gson gson) {
    super(gson, JsonPathFactory.CATEGORIES.getPath(), new TypeToken<Set<Category>>() {
    }.getType());
  }
